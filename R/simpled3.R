...
#'
#' @export
simpled3 <- function(data, colors = NULL, width = NULL, height = NULL, elementId = NULL) {
...
#'
#' @export
simpled3Output <- function(outputId, width = '100%', height = '400px'){
  htmlwidgets::shinyWidgetOutput(outputId, 'simpled3', width, height, package = 'simpled3')
}

#' @rdname simpled3-shiny
#' @export
renderSimpled3 <- function(expr, env = parent.frame(), quoted = FALSE) {
